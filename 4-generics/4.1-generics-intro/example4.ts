// JavaScript's Set is a generic type in TypeScript
...
const materials = new Set<"steel" | "aluminum" | "plastic">(["plastic"]); // can't infer a string literal represents a union
...
const employees = new Set<Employee>([{ name: "Alice" }]); // can't infer since there are two types with a compatible structure
